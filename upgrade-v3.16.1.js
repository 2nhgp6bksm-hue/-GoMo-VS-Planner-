...
/* GoMo VS Planner v3.19 — nettoyage visuel iPhone + modules Course, Semaine et pilotage adaptatif. */
(() => {
  ...
  function clean(){
    ...
    enhanceFinalScore();document.documentElement.setAttribute('data-gomo-v319-visual-ready','1');
  }
