const CACHE='gomo-vs-planner-v2.10.0';
const ASSETS=['./','./index.html','./styles.css?v=2.10.0','./app.js?v=2.10.0','./manifest.webmanifest','./icon-192.png','./icon-512.png','./gomo-vs-planner.png?v=2.10.0'];
