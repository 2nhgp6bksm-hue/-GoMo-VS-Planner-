  ...
  if(!html.includes(CENTRAL_MARKER)){
    const style=`<style id="gomo-central-back-style">
      ...
      @media(max-width:580px){
        .gomo-central-back{z-index:8;width:42px;min-width:42px;height:42px;min-height:42px;padding:0;border-radius:50%}
        .gomo-central-back .gomo-central-back-text{display:none}
      }
    </style>`;
