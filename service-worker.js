const CACHE='gomo-vs-planner-v3.20.4';

const ASSETS=[
  './',
  './index.html',
  './styles.css?v=3.15.0',
  './theme-ivory-gold.css?v=3.20.4',
  './theme-mascot-gold.css?v=3.20.4',
  './app.js?v=3.15.0',
...
self.addEventListener('install',event=>{
  event.waitUntil(caches.open(CACHE).then(cache=>Promise.allSettled(ASSETS.map(asset=>cache.add(new Request(asset,{cache:'reload'}))))).then(()=>self.skipWaiting()));
});
